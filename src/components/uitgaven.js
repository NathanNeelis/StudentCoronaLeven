...
import PSFive from '../img/ps5.png';
...
export default function Uitgaven (props) {
    ...
    <section id="uitgaven" className="Topic">
        <article className="datavisUitgaven">
            ...
            <div className="uitgavenContainer">
                <img src={Piechart} alt="Piechart" className="UitgavenVisual" />
            </div>
        </article>
        ...
        <article className="messages">
            ...
            <div className="messageContainer">
                ...
                <MessageImage src={AvatarJustin} name={Justin} message={messageThree} side='messageRight' image={PSFive} alt="Playstation 5 image" />
